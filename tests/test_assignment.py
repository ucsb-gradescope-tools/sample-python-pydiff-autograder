...
class TestAssignment(unittest.TestCase):
  ...
  def test_out(self):
    ...
    self.compareOutput("python3 helloConsole.py")

  @weight(10)
  def test_err(self):
    #Compare the stderr of the reference and student solution for helloConsole.py
    self.compareOutput("python3 helloConsole.py", stdout = False, stderr = True)

  @weight(10)
  def test_file(self):
    #Compare the contents of 'hello.txt' after it is created by the reference
    #solution and the student solution
    self.compareOutput("python3 helloFile.py", stdout = False, extra_outfiles=["hello.txt"])
